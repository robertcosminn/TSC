...
# Load project
  ...
  eval vsim -novopt -quiet -nocoverage +notimingchecks +nowarnTSCALE -sva -G/top/test/Number_of_Transaction=$2 -G/top/test/RND_CASE=$3 -G/top/test/seed=$4 top
#  eval vsim -novopt -quiet -nocoverage +notimingchecks +nowarnTSCALE -sva -G/top/test/RND_CASE=$3 top
#  eval vsim -novopt -quiet -nocoverage +notimingchecks +nowarnTSCALE -sva -G/top/test/seed=$4 top
